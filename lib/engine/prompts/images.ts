...
- Every field describes ONLY what the finished image SHOWS. Write it as a positive instruction ("show the printed panel, sharp and evenly lit"), keep the wording to what the camera sees and what the label states, and keep the overlay text to product facts. A brief carries production direction and product facts and nothing else: the compliance, policy and copy rules are handled elsewhere in this system and belong in no brief, because a brief is customer-adjacent copy scanned exactly like a bullet — a rule you restate here ships as copy.

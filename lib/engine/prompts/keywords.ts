...
- "why" is required on every row: one short sentence of evidence.
...
- Cover the listing properly: the head terms, the named entities, the qualifier and trust terms, the buyer-language phrases, the invisible-only variants, and the terms this listing deliberately leaves alone.
